...
'User ID': 'ID de Usuario',
'User Idreference Auth User': 'User Idreference Auth User',
'User Logged-out': 'El usuario finalizó la sesión',
'Username': 'Nombre de usuario',
'Username retrieve': 'Recuperar nombre de usuario',
'Usuario': 'Usuario',
'Value already in database or empty': 'Ya existe en la base de datos o está vacío',
